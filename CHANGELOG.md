...
- Fail closed when cancellation is not acknowledged, suppress the replaced native stopped notification, and document the upstream limitation for nested and workflow-owned children.
